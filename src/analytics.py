...
def plot_radar_chart(row, user_vector=None):
    ...
    # vino
    ax.plot(angles, wine_values, linewidth=0.5, color=accent_color)
    ...
    if user_vector is not None:
        ...
        ax.plot(angles, user_values, linestyle="dashed", linewidth=0.5, color=user_color)
    ...
    ax.set_yticklabels([], color="white", fontsize=5)
